...
import com.rohit.technbeat.adminModules.AdminPanelSelection
...
class menu : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbaradmin.setTitle("adminSection Login")
        ...
        loginadmin.setOnClickListener {
            ...
            Toast.makeText(this, "You Are Not An adminSection.)", Toast.LENGTH_LONG).show()
        }
    }
