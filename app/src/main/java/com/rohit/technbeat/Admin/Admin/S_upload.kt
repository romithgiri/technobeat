...
class S_upload: AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataReference = FirebaseDatabase.getInstance().getReference("Sponsors")
        imageReference = FirebaseStorage.getInstance().reference.child("Sponsors")
